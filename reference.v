...
module alu_refereince_model(
    ...
    always @(*) begin
        ...
        if (MODE) begin  // Arithmetic Mode
            ...
            case(CMD)
                4'b0000: RES = {1'b0, OPA & OPB};       // AND
                4'b0001: RES = {1'b0, ~(OPA & OPB)};    // NAND
                4'b0010: RES = {1'b0, OPA | OPB};       // OR
                4'b0011: RES = {1'b0, ~(OPA | OPB)};    // NOR
                4'b0100: RES = {1'b0, OPA ^ OPB};       // XOR
                4'b0101: RES = {1'b0, ~(OPA ^ OPB)};    // XNOR
                4'b0110: RES = {1'b0, ~OPA};            // NOT_A
                4'b0111: RES = {1'b0, ~OPB};            // NOT_B
                4'b1000: RES = {1'b0, OPA >> 1};        // SHR1_A
                4'b1001: RES = {1'b0, OPA << 1};        // SHL1_A
                4'b1010: RES = {1'b0, OPB >> 1};        // SHR1_B
                4'b1011: RES = {1'b0, OPB << 1};        // SHL1_B
